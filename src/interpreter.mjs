...
export class Interpreter {
    ...
    evaluateBooleanOperation(node) {
        ...
        // Add provenance info so UI can show contributing shapes
        try {
            result.sourceShapes = Array.isArray(shapeNames) ? [...shapeNames] : [];
            result.params = result.params || {};
            if (!result.params.operation) result.params.operation = operation;
        } catch (_) {}
